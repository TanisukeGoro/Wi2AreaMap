...
import os
import math
# This program is getting "Wi2 300" wi-fi service areas.
# the following describes the configuration of the program.
# FUNCTION
# read_table
# constant parameter
# END = 47 * 8
MAX_LEN = 30
URL_ID1 = '&search_type=xlos&pageID=0/ClassSkeletownController.php?'\
           'action=area&emx=1&isp=&pageID='
# ------
